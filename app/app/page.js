    ...
    <main className="space-y-10">
      <header className="border-b-2 border-brass pb-4 mb-2">
        ...
        <div className="flex items-end justify-between mt-1">
          <h1 className="font-display text-3xl uppercase tracking-wide text-paper">KvK Governor Tracker</h1>
          <a href="/admin" className="font-data text-xs tracking-wider text-steel hover:text-brassBright uppercase">Admin →</a>
        </div>
      </header>

      <section className="bg-panel rounded-sm p-6 border border-hairline field-card space-y-3">
        <h2 className="font-display text-lg uppercase tracking-wide text-paper">Alliance totals — {allianceTotals?.eventName || "current KvK"}</h2>
        {allianceLoading ? (
